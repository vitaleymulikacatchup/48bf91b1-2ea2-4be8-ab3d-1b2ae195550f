...
export const metadata: Metadata = {
  title: "Your Brand - Innovative Solutions for Business Growth",
  description: "Explore our services tailored for your business. Find out how we can help you succeed.",
  openGraph: {
    title: "Your Brand - Innovative Solutions",
    description: "Explore our services tailored for your business.",
    siteName: "Your Brand"
  },
  twitter: {
